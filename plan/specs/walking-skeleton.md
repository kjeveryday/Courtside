...
- **Gate question (framework §1):** _Spec confirmed, questions answered?_
...
- **Not in S1:** design tokens/fonts (S2) · `Verified<T>/Claimed<T>` UI enforcement
  ...
  S1's Vite dev server is dev tooling on loopback, _not_ the Courtside server; the
...
- header **Courtside** · green **fixture validates ✓ courtside/v0** · chip
  **phase 5 · battle-core** · agent block **parked_at_gate**, since 7:42 PM,
  _"Wired range overlay into DebugBattle; all 14 GUT tests green. Next: your
  review."_, **TASK-12**.
