...
// each `npm run dev` starts the story at "gate pending, your call". The fixture's
// own runtime dir (demo chain/db — never the real project's) goes with it.
rmSync(new URL('../.courtside/', planDir), { recursive: true, force: true });
